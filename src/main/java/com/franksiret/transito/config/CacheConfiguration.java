package com.franksiret.transito.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.franksiret.transito.domain.Tematicas.class.getName());
            createCache(cm, com.franksiret.transito.domain.Tematicas.class.getName() + ".preguntas");
            createCache(cm, com.franksiret.transito.domain.Preguntas.class.getName());
            createCache(cm, com.franksiret.transito.domain.Artinc.class.getName() + ".preguntas");
